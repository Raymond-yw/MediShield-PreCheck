...
export type { MediShieldPreCheck } from "./contracts/MediShieldPreCheck";
export { MediShieldPreCheck__factory } from "./factories/contracts/MediShieldPreCheck__factory";
